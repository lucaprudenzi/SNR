...
real theta=30*pi/180;//90-Latitude
real phi=30*pi/180;//Longitude
real south=10*pi/180;//rotation angle of x-axis from south
...
write("Psi angle in detector frame: ", 360-bindetlong);
